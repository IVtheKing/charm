...
int test_TBE(int argc, char *argv[])
{
	...
	OS_CreatePeriodicTask( 1000, 1000, 500, 100, stack1, sizeof(stack1), "LED1", &task1, task_TBE, &a);
 	...
 	OS_CreatePeriodicTask( 5000, 5000, 300, 210, stack3, sizeof(stack3), "LED3", &task3, task_TBE, &c);
 	OS_CreatePeriodicTask(1000000, 1000000, 40000, 0, stack4, sizeof(stack4), "LED4", &task4, task_TBE, &d);
