...
//	OS_CreatePeriodicTask(10000, 10000, 2500, 1000, stack4, sizeof(stack4), &task4, task_fn2, &d);
	...
	OS_CreatePeriodicTask( 10000, 10000, 500, 100, stack1, sizeof(stack1), "LED1", &task1, task_fn1, &a);
 	OS_CreatePeriodicTask( 12000, 12000, 2000, 4500, stack2, sizeof(stack2), "LED2", &task2, task_fn1, &b);
 	OS_CreatePeriodicTask( 50000, 50000, 3000, 2100, stack3, sizeof(stack3), "LED3", &task3, task_fn1, &c);
 	OS_CreatePeriodicTask(100000, 100000, 4000, 3700, stack4, sizeof(stack4), "LED4", &task4, task_fn1, &d);
